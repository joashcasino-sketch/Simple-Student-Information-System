...
class UpdateStudentDialog:
    def __init__(self, parent, controller, student_data):
        ...
        self.dialog.grab_set()  # ← makes it modal like AddStudentDialog
        ...
        # ID (read-only — shouldn't change the primary key)
        ...
        self.id_entry.config(state="disabled")  # ← lock ID
        ...
        self.year_entry.insert(0, student_data[3])
        ...
        self.program_entry.insert(0, student_data[4])
        ...
        self.college_entry.insert(0, student_data[5])
